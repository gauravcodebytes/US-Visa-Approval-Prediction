...
class S3Client:
    ...
    s3_client=None
    s3_resource = None
    def __init__(self, region_name=REGION_NAME): #constructor inside S3Client class and then the code for connecting to S3 using boto3
        """ 
        ...
        if S3Client.s3_resource==None or S3Client.s3_client==None:
            __access_key_id = os.getenv(AWS_ACCESS_KEY_ID_ENV_KEY, ) #getenv is to get the AWS access key declared in environment
